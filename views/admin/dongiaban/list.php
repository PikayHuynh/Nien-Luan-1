    ...
    <nav>
        <ul class="pagination justify-content-center">
            ...
            <?php if ($currentPage > 1): ?>
                <li class="page-item">
                    <a class="page-link" href="?controller=dongiaban&action=index&page=<?= $currentPage - 1 ?>">« Prev</a>
                </li>
            <?php endif; ?>
            ...
            <?php for ($i = $startPage; $i <= $endPage; $i++): ?>
                <li class="page-item <?= ($i == $currentPage) ? 'active' : '' ?>">
                    <a class="page-link" href="?controller=dongiaban&action=index&page=<?= $i ?>">
                        <?= $i ?>
                    </a>
                </li>
            <?php endfor; ?>
            ...
            <?php if ($currentPage < $totalPages): ?>
                <li class="page-item">
                    <a class="page-link" href="?controller=dongiaban&action=index&page=<?= $currentPage + 1 ?>">Next »</a>
                </li>
            <?php endif; ?>
