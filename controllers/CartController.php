...
/**
 * Lớp CartController quản lý các chức năng liên quan đến giỏ hàng.
 */
class CartController {
    ...
    public function add() {
        ...
        if (isset($_SESSION['cart'][$id])) {
            ...
            // Lấy thông tin sản phẩm (ưu tiên phương thức client nếu có)
    ...
    /**
     * Tính toán lại tổng tiền giỏ hàng và cập nhật session.
